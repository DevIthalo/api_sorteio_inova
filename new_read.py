...
def get_random_row(valor_pesquisa):
    ...
    try:
        ...
        # Criar um DataFrame a partir dos dados do Google Sheets
        df = pd.DataFrame(values, columns=['vendedor', 'cliente', 'telefone', 'comprovante', 'ponto'])
        ...
        if not resultado.empty:
            ...
            random_data = resultado.iloc[0].to_dict()
            return {
                    'vendedor': random_data["vendedor"],
                    'cliente': random_data["cliente"],
